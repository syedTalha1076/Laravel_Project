...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <form action="<?php echo e(route('admin.activity-log.clear')); ?>" method="POST" onsubmit="return confirm('Clear ALL log entries permanently?')">
                <?php echo csrf_field(); ?>
                <button type="submit"
        ...
        <div class="box-shadow rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
            <?php if($logs->count()): ?>
                            ...
                            <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="border-b border-gray-100 transition-colors hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800/50">
                                    <td class="px-4 py-3 font-medium text-gray-800 dark:text-white">
                                        <?php echo e(optional($log->user)->name ?? 'System'); ?>

                                    </td>
                                    <td class="px-4 py-3">
                                        <span class="inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold <?php echo e($colorClass); ?>">
                                            <?php echo e(ucfirst($log->activity_type)); ?>
                                    ...
                                    <td class="px-4 py-3 text-xs text-gray-500 dark:text-gray-500">
                                        <?php echo e($log->activity_date->format('d M Y H:i:s')); ?>

                                    </td>
                                    <td class="px-4 py-3">
                                        <form action="<?php echo e(route('admin.activity-log.delete', $log->id)); ?>" method="POST" onsubmit="return confirm('Delete this entry?')">
                ...
                <?php if($logs->hasPages()): ?>
                    <div class="border-t border-gray-200 px-4 py-3 dark:border-gray-800"><?php echo e($logs->links()); ?></div>
                <?php endif; ?>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH D:\XAMPP_Install\htdocs\crm_modules_final\packages\Webkul\Admin\src/resources/views/activity-log/index.blade.php ENDPATH**/ ?>