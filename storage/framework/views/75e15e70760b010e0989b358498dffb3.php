...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Follow-Ups <?php $__env->endSlot(); ?>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <a href="<?php echo e(route('admin.follow-ups.create')); ?>" class="primary-button">+ Schedule Follow-Up</a>
        </div>
            ...
            <?php if($followUps->count()): ?>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $followUps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $statusClasses = [
                                ...
                                <tr class="border-b border-gray-100 transition-colors hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800/50">
                                    <td class="px-4 py-3 font-medium text-gray-800 dark:text-white"><?php echo e(optional($f->lead)->title ?? 'N/A'); ?></td>
                                    <td class="px-4 py-3 text-gray-600 dark:text-gray-400"><?php echo e(($typeIcons[$f->follow_up_type] ?? '📌') . ' ' . ucfirst($f->follow_up_type)); ?></td>
                                    <td class="px-4 py-3 text-gray-600 dark:text-gray-400"><?php echo e(optional($f->user)->name ?? '—'); ?></td>
                                    <td class="px-4 py-3 text-gray-600 dark:text-gray-400"><?php echo e($f->follow_up_date->format('d M Y H:i')); ?></td>
                                    <td class="px-4 py-3 text-gray-500 dark:text-gray-500 text-xs"><?php echo e($f->next_follow_up_date ? $f->next_follow_up_date->format('d M Y') : '—'); ?></td>
                                    <td class="px-4 py-3">
                                        <span class="inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold <?php echo e($statusClasses[$f->status] ?? ''); ?>">
                                            <?php echo e(ucfirst($f->status)); ?>

                                        </span>
                                    </td>
                                    <td class="px-4 py-3 text-gray-500 dark:text-gray-500 text-xs max-w-xs truncate"><?php echo e($f->notes ?: '—'); ?></td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-2">
                                            <a href="<?php echo e(route('admin.follow-ups.edit', $f->id)); ?>"
                                            ...
                                            <form action="<?php echo e(route('admin.follow-ups.delete', $f->id)); ?>" method="POST" onsubmit="return confirm('Delete this follow-up?')">
                ...
                <?php if($followUps->hasPages()): ?>
                    <div class="border-t border-gray-200 px-4 py-3 dark:border-gray-800"><?php echo e($followUps->links()); ?></div>
                <?php endif; ?>
            <?php else: ?>
                <div class="flex flex-col items-center justify-center gap-3 py-16">
                    ...
                    <a href="<?php echo e(route('admin.follow-ups.create')); ?>" class="primary-button mt-2">+ Schedule Follow-Up</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\XAMPP_Install\htdocs\crm_modules_final\packages\Webkul\Admin\src/resources/views/follow-ups/index.blade.php ENDPATH**/ ?>