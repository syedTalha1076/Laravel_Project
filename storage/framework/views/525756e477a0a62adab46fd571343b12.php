<?php if(isset($attribute)): ?>
    ...
    <v-lookup-component
        ...
        :value="<?php echo e(json_encode($lookUpEntityData)); ?>"
        can-add-new="<?php echo e($canAddNew ?? false); ?>"
    ...
    >
        <div class="relative inline-block w-full">
            ...
            <div class="relative flex items-center justify-between rounded border border-gray-200 p-2 hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:text-gray-300">
                <?php echo app('translator')->get('admin::app.components.attributes.lookup.click-to-add'); ?>
...
<?php if (! $__env->hasRenderedOnce('faf05821-8223-4adf-9919-d05f3d132b99')): $__env->markAsRenderedOnce('faf05821-8223-4adf-9919-d05f3d132b99');
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {{ selectedItem?.name !== "" ? selectedItem?.name : "<?php echo app('translator')->get('admin::app.components.attributes.lookup.click-to-add'); ?>" }}
                    </span>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'hidden',':name' => 'attribute[\'code\']','v-model' => 'selectedItem.id',':rules' => 'validations',':label' => 'attribute[\'name\']']); ?>
            ...
            >
                ...
                <div class="relative flex items-center">
                    ...
                    <input
                        ...
                        placeholder="<?php echo app('translator')->get('admin::app.components.attributes.lookup.search'); ?>"
                        ref="searchInput"
                        @keyup="search"
                    />
                ...
                <ul class="max-h-40 divide-y divide-gray-100 overflow-y-auto">
                    ...
                    <template v-if="filteredResults.length === 0">
                        <li class="px-4 py-2 text-center text-gray-500">
                            <?php echo app('translator')->get('admin::app.components.attributes.lookup.no-result-found'); ?>
                        </li>
        ...
        app.component('v-lookup-component', {
            ...
            data() {
                return {
                    ...
                    searchRoute: `<?php echo e(route('admin.settings.attributes.lookup')); ?>/${this.attribute.lookup_type}`,

                    lookupEntityRoute: `<?php echo e(route('admin.settings.attributes.lookup_entity')); ?>/${this.attribute.lookup_type}`,
...
<?php /**PATH D:\XAMPP_Install\htdocs\CRM_2250_2244_2263_2301\packages\Webkul\Admin\src/resources/views/components/attributes/edit/lookup.blade.php ENDPATH**/ ?>